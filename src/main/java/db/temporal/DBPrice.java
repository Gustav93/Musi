...
//    }
    ...
    public List<Price> filtrarPor(Filtro filtro)
    {
        ...
        if(filtro.equals(Filtro.SIN_FILTRAR))
            ...
            //language=SQL
            query = "select * from price where processed = 'Procesado con Error' or processed = 'Sin Procesar' or processed = 'Procesado con Warning'";
    ...
    private int getCantRegistros(Contador contador, String nombreArchivo)
    {
        ...
        if(contador.equals(Contador.PROCESADO))
            ...
            //language=SQL
            query = "select count(*) from price where importOrigin like ? and processed like 'Procesado con Error' or processed like 'Procesado con Warning'";
            ...
            //language=SQL
            query = "select count(*) from price where importOrigin like ? and processed like 'Procesado con Warning'";
    ...
    private int getCantRegistros(Contador contador)
    {
        ...
        if(contador.equals(Contador.PROCESADO))
            ...
            //language=SQL
            query = "select count(*) from price where processed like 'Procesado con Error' or processed like 'Procesado con Warning'";
            ...
            //language=SQL
            query = "select count(*) from price where processed like 'Procesado con Warning'";
