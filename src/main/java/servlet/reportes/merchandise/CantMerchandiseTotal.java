...
@WebServlet
public class CantMerchandiseTotal extends HttpServlet
{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if(codigoProducto.equals("false"))
        {
            ...
            totalMerchandise = String.valueOf(dbMerchandise.getCandidadTotalRegistros());
        }

        else
        {
            HistoricoMerchandise historicoMerchandise = new HistoricoMerchandise();
            totalMerchandise = String.valueOf(historicoMerchandise.getCantidadRegistros(codigoProducto));
        }
