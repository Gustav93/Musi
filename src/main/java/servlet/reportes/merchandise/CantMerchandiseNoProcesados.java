...
@WebServlet
public class CantMerchandiseNoProcesados extends HttpServlet
{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if(codigoProducto.equals("false"))
        {
            ...
            totalMerchandise = String.valueOf(dbMerchandise.getCantidadRegistrosNoProcesados());
        }

        else
        {
            HistoricoMerchandise historicoMerchandise = new HistoricoMerchandise();
            totalMerchandise = String.valueOf(historicoMerchandise.getCantidadRegistrosNoProcesados(codigoProducto));
        }
