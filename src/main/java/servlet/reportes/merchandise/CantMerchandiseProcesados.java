...
@WebServlet
public class CantMerchandiseProcesados extends HttpServlet
{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if(codigoProducto.equals("false"))
        {
            ...
            totalMerchandise = String.valueOf(dbMerchandise.getCantidadRegistrosProcesados());
        }

        else
        {
            HistoricoMerchandise historicoMerchandise = new HistoricoMerchandise();
            totalMerchandise = String.valueOf(historicoMerchandise.getCantidadRegistrosProcesados(codigoProducto));
        }
