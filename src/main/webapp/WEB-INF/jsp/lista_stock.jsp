                            ...
                            <div class="x_content">
                                ...
                                <table id="grilla" class="table">
                                    ...
                                    <%
                                        ...
                                        List<Stock> listaStock = (ArrayList<Stock>) request.getAttribute("listaStock");

                                        for(Stock stock : listaStock)
                                        {
                                    %>
                                    <tr>
                                        <td><%= stock.getProductCode() %></td>
                                        <td><%= stock.getStock() %></td>
                                        <td><%= stock.getWarehouse() %></td>
                                        <td><%= stock.getStatus() %></td>
                                        <td><%= stock.getImportOrigin() %></td>
                                        <td><%= stock.getProcessed() %></td>
                                        <td><%= stock.getErrorDescription() %></td>
                                    </tr>
                                    <%}%>
                                    </tbody>
                                </table>
