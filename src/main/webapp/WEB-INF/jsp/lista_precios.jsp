                            ...
                            <div class="x_content">
                                ...
                                <table id="grilla" class="table">
                                    ...
                                    <%
                                        ...
                                        List<Price> precios = (ArrayList<Price>) request.getAttribute("listaPrecios");
                                    ...
                                    <tr>
                                        ...
                                        <td><%= p.getOnlinePrice() %></td>
                                        <td><%= p.getCurrency() %></td>
                                        <td><%= p.getStorePrice() %></td>
                                        <td><%= p.getHasPriority() %></td>
